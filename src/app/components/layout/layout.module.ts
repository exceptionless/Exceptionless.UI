...
export const ROUTES: Routes = [
    {
        ...
        children: [ // TODO: These need to be dynamically registered as there is a bunch of duplicates here.... In old version we were also doing validation that ids exist...
